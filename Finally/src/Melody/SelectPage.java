...
public class SelectPage extends JFrame 
{
    ...
    private Audio[] selectedBackgroundMusic = {new Audio("src/musics/airplane.wav", true), new Audio("src/musics/butterfly.wav", true), new Audio("src/musics/threebears.wav",true)};
    private Audio selectedButtonSound = new Audio("src/musics/buttonEnteredMusic.wav", false);
